...
import os from "os";
import { BASE_DIR, ACCOUNTS_FILE, PREFERENCES_FILE, CREDENTIALS_FILE } from "../src/config.js";
...
describe("config", () => {
  ...
  it("exports PREFERENCES_FILE inside BASE_DIR", () => {
    expect(PREFERENCES_FILE).toBe(`${BASE_DIR}/preferences.json`);
  });
